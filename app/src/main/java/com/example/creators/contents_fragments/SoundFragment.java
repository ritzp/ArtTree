...
public class SoundFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View root = inflater.inflate(R.layout.contents_fragment_sound, container, false);
        Bundle bundle = getArguments();
        contentsId = bundle.getString("contentsId");
        extension = bundle.getString("extension");

        playerView = root.findViewById(R.id.condetailSnd_player);
    ...
    private void initPlayer() {
        ...
        try {
            MediaItem mediaItem = new MediaItem.Builder().setUri(Uri.parse(JspHelper.getSoundURL(contentsId, extension))).build();
